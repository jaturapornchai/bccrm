...
**โมเดลโปรเจกต์:** Open Source (self-host ฟรี) + บริการเสริมแบบ Open-Core (ดูส่วนที่ 10)
...
2. **License** — ยืนยัน AGPLv3 หรืออยากได้ Apache 2.0 (เปิดกว่า แต่เสี่ยงถูกเอาไปทำ SaaS แข่ง)?
3. **Mobile app** — ยืนยัน Flutter หรืออยากได้ React Native?
...
### 10.1 License ที่แนะนำ

| ตัวเลือก | เหมาะถ้า | ข้อควรรู้ |
|---|---|---|
| **AGPLv3** (แนะนำ) | อยากให้คนเอาไปใช้/แก้ได้ แต่ถ้าเอาไปทำ SaaS ขายต้องเปิด source คืน | ป้องกันคู่แข่งเอาไปห่อขาย; รูปแบบเดียวกับที่ Chatwoot, Cal.com ใช้ |
| Apache 2.0 | อยากให้ adopt ง่ายสุด รวมถึงบริษัทเอาไปใช้ปิดได้ | กระจายตัวเร็ว แต่ควบคุมการ monetize ของคนอื่นไม่ได้ |
| Open-Core: Core = AGPLv3, Enterprise = เชิงพาณิชย์ | ต้องการรายได้จากฟีเจอร์ขั้นสูง | ต้องแยก package ชัดเจนตั้งแต่วันแรก |

ฟีเจอร์ LINE/LIFF ผูกกับบัญชี LINE OA ของผู้ใช้เอง (แต่ละร้านใช้ channel token ของตัวเอง) จึงไม่มีปัญหาเรื่องการแจก credentials ในโค้ดเปิด
...
### 10.4 โมเดลรายได้ (เลือกทีหลังได้ ไม่บล็อกการพัฒนา)

- **Hosted Cloud** — เรา host ให้ร้านที่ไม่อยากดูแลเอง (รายเดือนตามสาขา/โควต้าข้อความ LINE)
- **Enterprise support / ติดตั้ง on-premise** — โรงพยาบาล, หน่วยงานราชการ
- **Marketplace ปลั๊กอิน** — แบ่งรายได้กับนักพัฒนา connector
- ฟีเจอร์ที่เหมาะเก็บเป็น enterprise: multi-tenant billing, SSO, audit log, HA/cluster mode
